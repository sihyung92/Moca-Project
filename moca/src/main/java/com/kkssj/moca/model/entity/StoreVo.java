...
public class StoreVo {
	...
	private double tasteLevel, priceLevel,serviceLevel, moodLevel, easeLevel, averageLevel;
	...
	public StoreVo(int store_Id, int kakaoId, String name,String category,String address,String roadAddress,double xLocation,
			 ...
			 int wifi, int parkingLot, String dayOff, double tasteLevel, double priceLevel, double serviceLevel, double moodLevel, double easeLevel)
	{
		super();
	...
	public double getEaseLevel() {
		return easeLevel;
	}

	public void setEaseLevel(double easeLevel) {
		this.easeLevel = easeLevel;
	}
	...
	public int hashCode() {
		...
		temp = Double.doubleToLongBits(easeLevel);
		result = prime * result + (int) (temp ^ (temp >>> 32));
	...
	public boolean equals(Object obj) {
		...
		if (dayOff == null) {
			...
			return false;
		if (Double.doubleToLongBits(easeLevel) != Double.doubleToLongBits(other.easeLevel))
			return false;
	...
	public String toString() {
		return "StoreVo [store_Id=" + store_Id + ", kakaoId=" + kakaoId + ", reviewCnt=" + reviewCnt + ", wifi=" + wifi
				...
				+ ", easeLevel=" + easeLevel + ", averageLevel=" + averageLevel + ", openTime=" + openTime
				+ ", endTime=" + endTime + "]";
	}
